# Construcció i arrencada de contenidors
![alt text](screenshots/primera.png)
![alt text](screenshots/segona.png)

# Verificació de l'estat dels contenidors
![alt text](screenshots/tercer.png)

# Accés a la interfície de préstecs mitjançant el port 8080
![alt text](screenshots/quart.png)

[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=22926509&assignment_repo_type=AssignmentRepo)
